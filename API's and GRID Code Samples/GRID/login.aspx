...
<img src="img/spacer.gif" width="100%" height="100px"> <!-- NOTE: ADJUST THE HEIGHT OF THE TABLE ON THE PAGE BY REDUCING OR INCREASING THE HEIGHT OF THE SPACER.GIF IMAGE -->
		...
		<table align="center">
			...
			<tr align="center">
				...
				<input id="BSID_challengeButton" type="button" name="grid" value='Get Grid' title="Get Grid" onClick="getChallenge(document.getElementById('txtID').value)">         
                 		<asp:Button id="btnLogin" OnClick="submit" runat="server" Text="Login"></asp:Button>&nbsp;&nbsp;
			</tr>
			<tr>
				<td height="12"><img src="img/spacer.gif" width="5" height="12"></td>
			</tr>
				...
				<div id="challengeImageDiv" style="visibility:hidden; display:none;"><img id="challengeImage" src=""/></div>
...
var BlackShieldServerLocation = "https://spedemo.cryptocard.com/blackshieldss/O/Q0ROY24P2N/index.aspx";

function getChallenge(userName){
    var challengeImg = document.getElementById("challengeImage");
    challengeImg.src = BlackShieldServerLocation + "?getChallengeImage=true&userName=" + userName + "&noCache=" + new Date().toString();
